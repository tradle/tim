...
const BacklinksTabBar = createReactClass({
  propTypes: {
  ...
  renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler) {
    ...
    let countC
    if (count) {
      countC = <View style={styles.count}>
  ...
  render() {
    const tabUnderlineStyle = {
      position: 'absolute',
      height: 4,
      backgroundColor: this.props.tabsUnderlineColor  ||  '#7AAAC3',
      bottom: 0,
    };
...
module.exports = BacklinksTabBar;
