...
class ShowPropertiesView extends Component {
  ...
  renderGroups(resource, viewCols, groups, propsIn, styles) {
    ...
    let isSmall = utils.isSmallScreen(ShowPropertiesView)
      ...
      if (isSmall  ||  size < 4  ||  hasMarkdown || hasItems) {
        if (hasMarkdown  ||  hasItems  ||  i > 0) {
          ...
          if (hasMarkdown  ||  hasItems) {
            ...
            groupView = <View style={{margin: 10, borderColor: '#eee', borderWidth: 1, borderRadius: 15 }}>
 ...
 */
        ...
        if (i === 0) {
          groupBody = <View style={{borderColor: '#eee', borderWidth: 1, borderRadius: 15 }}>
                      <LinearGradient colors={colors} style={styles.linearGradient}>
                        {groupBody}
                      </LinearGradient>
                      </View>
          ...
          groupView = <View style={{margin: 10, backgroundColor: i===0 ? 'transparent' : '#fafafa', borderColor: '#eeeeee', borderRadius: 15, borderWidth: 1, paddingBottom: 10 }}>
                        {groupBody}
                      </View>
      }
