  ...
  render() {
    ...
    if (meta.id === 'tradle.PhotoID') {
      guidanceMsg = <View style={{padding: 20, marginHorizontal: -10, backgroundColor: bankStyle.GUIDANCE_MESSAGE_BG}}>
                      <Text style={{fontSize: 18, marginBottom:10}}>Uploading a picture of your document to your computer:</Text>
                      ...
                      <Text style={{fontSize: 18}}>2.
                        <Text style={{fontSize: 18, paddingLeft: 10}}>Transfer the image from your device to your computer: connect to the device with a USB cable, or email the image to yourself. Save the image to your computer.</Text>
                      </Text>
