...
import mcbuilder, { buildResourceStub } from '@tradle/build-resource'
    ...
    function save (wrapper) {
      ...
      return getFromTo
        .then(msgInfo => {
          ...
          let from = self._getItem([PROFILE, msgInfo.author].join('_'))
          let to = self._getItem([PROFILE, msgInfo.recipient].join('_'))
